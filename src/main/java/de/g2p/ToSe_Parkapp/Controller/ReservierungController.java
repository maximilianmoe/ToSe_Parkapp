...
//        mailService.sendSimpleMessage("lehnermaxi@yahoo.de", "Test", "test");
        ...
        model.addAttribute("kosument", new Konsument());
        return "spezieller_parkplatz";

    }

    @PostMapping("/reserve")
    public String reserveParkplatz(@ModelAttribute Parkplatz parkplatz,
                                   @ModelAttribute Parken parken,
                                   @ModelAttribute Reservierung reservierung,
                                   @ModelAttribute Konsument konsument,
...
//    @GetMapping("/testlauf")
//    @ResponseBody
//    public List<Reservierung> testlauf() {
//        return reservierungenRepository.findAll();
//    }
